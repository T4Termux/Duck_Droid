...
def finaly ():
	...
	print (c+"|                                  |")
	print (c+"| \033[1;36mCooded By \033[1;34m :----->>   \033[1;31m Hamza.H   \033[1;34m|")
	print (c+"| \033[1;36mYoutube   \033[1;34m :----->>   \033[1;31m T4 Termux \033[1;34m|")
	print (c+"| \033[1;36mInsagram  \033[1;34m :----->>   \033[1;31m t4_termux \033[1;34m|")
	print (c+"| \033[1;36mGitHub    \033[1;34m :----->>   \033[1;31m T4Termux  \033[1;34m|")
...
def banner ():
	...
	print (c+fore+"       ■■  ■■             ■■  ■■")
	print (c+fore+"       ■■  ■■             ■■  ■■")
	print (c+fore+"       \033[1;47m   \033[1;34mĐûčk \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mĐrôid   \033[1;0m     ")
...
# Available options.
def chose_opt ():
	print ("\033[1;34mĐûčk \033[1;35m|\033[1;34m••\033[1;35m| \033[1;34mĐrôid\033[1;31m/~"+cyan+" Choose Your Payload\n")
	time.sleep (0.5)
	...
	print(" \n ")
	pld_type = int (input ("\033[1;34mĐûčk \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mĐrôid\033[1;31m/~  \033[1;36m"))
	if pld_type > 8:
		try:
			raise ValueError
		except ValueError:
...
def exite ():
	time.sleep (1.2)
	banner()
	print ("\n\n\033[1;34mĐûčk \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mĐrôid\033[1;31m/~"+cyan+"  BY BY SEE YOU SOON.\n\n")
	exit (0)
